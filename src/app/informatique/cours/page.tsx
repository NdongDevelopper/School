...
// Pas besoin de dynamic import pour jsPDF ici, il sera importé dynamiquement dans les fonctions qui en ont besoin.
        ...
        >
          ...
          <nav className="mt-6">
            <ul className="space-y-2 px-4">
              ...
              <li>
                <a href={`/${specialite}/emploi-du-temps`} className="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-blue-500 transition-colors cursor-pointer">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
