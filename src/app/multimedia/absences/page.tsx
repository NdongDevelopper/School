...
export default function AbsencesPage() {
  ...
  const absences: Absence[] = [
    { id: 1, date: "2025-10-01", matiere: "Design graphique", heures: 2, justifiee: false },
    { id: 2, date: "2025-10-05", matiere: "Animation 2D", heures: 1, justifiee: true },
    { id: 3, date: "2025-10-10", matiere: "Photographie numérique", heures: 3, justifiee: false },
    { id: 4, date: "2025-10-15", matiere: "Vidéo production", heures: 2, justifiee: true },
  ];
